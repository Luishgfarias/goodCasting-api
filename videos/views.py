...
from .serializers import ClassManagementSerializer
...
class ClassManagementViewSet(viewsets.ModelViewSet):
    queryset = ClassManagement.objects.all().order_by('order')
            ...
            try:
                ...
                if user.is_type.is_superuser:
                    ...
                    for n in user_permissions:
                        ...
                        if n.model == 'Aula' and n.function == 'Visualizar' and n.active == True:
    ...
    def create(self, request):
        ...
        if header_user != None:
            ...
            try:
                ...
                if user.is_type.is_superuser:
                    serializer = ClassManagementSerializer(data=request.data, context={'request': request})
                    ...
                    for n in user_permissions:
                        print(n.model, ' - ', n.function)
                        if n.model == 'Aula' and n.function == 'Inserir' and n.active == True:
                            permission = permission + 1
        ...
        if header_user != None:
            ...
            try:
                ...
                if user.is_type.is_superuser:
                    ...
                    serializer = ClassManagementSerializer(user)
                    return Response(serializer.data)
                else:
                    user_permissions = user.is_type.permission.all()
                    for n in user_permissions:
        ...
        if header_user != None:
            ...
            try:
                ...
                if user.is_type.is_superuser:
                    ...
                    serializer = ClassManagementSerializer(instance, context={'request': request}, data=request.data, partial=True)
                    serializer.is_valid(raise_exception=True)
                    ...
                    for n in user_permissions:
                        print(n.model, ' - ', n.function)
                        if n.model == 'Aula' and n.function == 'Atualizar' and n.active == True:
                            permission = permission + 1
        ...
        if header_user != None:
            ...
            try:
                ...
                if user.is_type.is_superuser:
                    ...
                    for n in user_permissions:
                        print(n.model, ' - ', n.function)
                        if n.model == 'Aula' and n.function == 'Excluir' and n.active == True:
                            permission = permission + 1
                            instance = self.get_object()
                            self.perform_destroy(instance)
